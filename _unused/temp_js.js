        ...
        function refresh() {
            ...
            api('/api/status?hours=' + filterHours).then(function(data) {
                ...
                if (btnAuto) {
                    ...
                    if (autoRunning) btnAuto.classList.add('on');
                    else btnAuto.classList.remove('on');
                }
                ...
                if (allSignals.length === 0) {
                    setHTML('signals', '<div class="no-data">No signals found. Market conditions: H4 and H1 trends must align (e.g., both BULLISH or both BEARISH) for a valid trade signal. Current market shows H4=Bearish, H1=Bullish - waiting for alignment.</div>');
                } else {
                    var sigHTML = '';
        ...
        function doScan() {
            ...
            setHTML('signals', '<div class="no-data" style="color:#58a6ff;">Scanning market...</div>');
